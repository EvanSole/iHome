package com.website.common.util.page;
 ...
 * 
 */
public class MySql5Page implements Dialect {

	protected static final String SQL_END_DELIMITER = ";";

	public String getPageSql(String sql, boolean hasOffset) {
		return getPageSqlString(sql, -1, -1);
	}

	public String getPageSql(String sql, int offset, int limit) {
		return getPageSqlString(sql, offset, limit);
	}
	 ...
	 * @return 分页SQL
	 */
	public static String getPageSqlString(String querySelect, int offset, int limit) {
